...
typedef enum {
    ...
    GPS_PORT_UART_2,
    GPS_PORT_UART_3,
    GPS_PORT_SOFTSERIAL_1, // Requires FEATURE_SOFTSERIAL
    GPS_PORT_SOFTSERIAL_2, // Requires FEATURE_SOFTSERIAL
    GPS_PORT_MAX = GPS_PORT_SOFTSERIAL_2
} GPSPort;
...
typedef enum {
    ...
    TELEMETRY_PORT_UART_3,
    TELEMETRY_PORT_MAX = TELEMETRY_PORT_UART_3
} TelemetryPort;
